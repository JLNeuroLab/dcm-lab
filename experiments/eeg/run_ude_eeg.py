...
def main(config_path: str):
    ...
    mlp          = EEGCouplingMLP(l=l, m=m, hidden_dim=hidden_dim, u_scale=u_scale, output_scale=output_scale).to(device)
    print(f"  MLP: hidden_dim={hidden_dim}, u_scale={u_scale}, output_scale={output_scale}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="experiments/configs/eeg/ude_6r_eeg.yaml",
    )
